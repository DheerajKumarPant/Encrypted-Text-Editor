...
public class TextEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jDialog3.setTitle("Encryption Options");
        jDialog3.setAlwaysOnTop(true);
        jDialog3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jDialog3.setFocusTraversalPolicyProvider(true);
        jDialog3.setForeground(java.awt.Color.white);
        jDialog3.setLocation(new java.awt.Point(400, 200));
        jDialog3.setMinimumSize(new java.awt.Dimension(401, 300));
        jDialog3.setName(""); // NOI18N
        ...
        jLabel7.setText("Enter Encryption Key ");
        ...
        jDialog4.setTitle("Decryption Options");
        jDialog4.setAlwaysOnTop(true);
        jDialog4.setLocation(new java.awt.Point(400, 200));
        jDialog4.setMinimumSize(new java.awt.Dimension(400, 200));
        jDialog4.setName(""); // NOI18N
        ...
        jDialog5.setTitle("Modified File");
        jDialog5.setAlwaysOnTop(true);
        jDialog5.setLocation(new java.awt.Point(481, 200));
        jDialog5.setMinimumSize(new java.awt.Dimension(481, 140));
        jDialog5.setResizable(false);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("File information is modified Or Key is wrong. Unable to Decrypt.");
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        ...
        jTextArea4.setText(HelpClass.Overview);
    ...
    private void jList5ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList5ValueChanged
        ...
        else if (label_text.equals("4. How to Decrypt?"))
        {
            jTextArea4.setText(HelpClass.Decrypt);
        }
        else if ( label_text.equals("2. How to Encrypt?"))
        {
            jTextArea4.setText(HelpClass.Encrypt);
        }
        else if (label_text.equals("3. Why Password"))
        {
            jTextArea4.setText(HelpClass.why_pass);
        }
        else 
        {
            jTextArea4.setText(HelpClass.Overview);
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        encryption_selected = true;
    }//GEN-LAST:event_jMenuItem9ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        password = new String();
        jDialog3.setVisible(false);
        encryption_selected = false;
    ...
    byte[] write_to_file;
    boolean encryption_selected = false;
        ...
        try 
        {
            if (!encryption_selected){
                ...
                try (FileOutputStream w = new FileOutputStream(fileName)) {
                    ...
                    w.write(tmp.getBytes());
                    w.close();
                }
                currentFile = fileName;
                if (!check_save_as)
                    new File(currentFile).renameTo(new File(currentFile+".txt"));
            ...
            else
            {
                ...
                currentFile = fileName;
                String s = currentFile+".vc";
                new File(currentFile).renameTo(new File(s));
                
                new File(s).setWritable(false);
    ...
    private void readInFile(String fileName)
    {
        try {
            ...
            {
                String enc = "File is ";
                if (isFileEncrypted(new File(fileName)))
                {
                    enc = enc + "Encrypted";
                    if (isModified(new File(fileName)))
                    {
                        enc = enc + " but modified.\nCan not be decrypted.";
    ...
    private void saveFileAs() 
    {
        if (encryption_selected)
        {
            FileNameExtensionFilter filter=new FileNameExtensionFilter("Encrypted Text File","vc");
            dialog.addChoosableFileFilter(filter);
        }
    ...
    private boolean isFileEncrypted(File f) throws IOException
    {
        ...
        {
            header[i] = b[i];
            footer[i] = b[b.length-1-i];
        }
       
        FileInfo info = new FileInfo();
        if(info.checkHeader(new String(header)))
            return true;
        else return info.checkFooter(new String(footer));
    }
    ...
    private boolean isModified(File f) 
    {
        ...
        FileInfo info = new FileInfo();
        b = info.decryptFirstLayer(new String(b)).getBytes();
        
        String str = info.removeHeaderAndFooter(new String(b));
       
        return info.checkModified(str);
    }
    ...
    private void encryptText() {
        if (password.length() > 0)
        {
            try
            {
                ...
                PermutationAndRotation obj2 = new PermutationAndRotation(password);
                FileInfo info = new FileInfo();
                info.setNumOfChars(jTextArea1.getText().length());
                String tmp = obj2.makeTextReadyForEncryption(jTextArea1.getText());
                tmp = new Round2Encryption(password).encryptAES(tmp);
                String encrypted_text = obj1.encryption(tmp);
                String hash_val = info.getEquivalentHash(encrypted_text);
                encrypted_text = info.fileInfoEncryption(encrypted_text);
                String header = info.getHeader();
                String footer = info.getFooter();
                String size_info = info.getPaddingAndChars();
                String final_text = header + hash_val + size_info + encrypted_text + footer;
                write_to_file = final_text.getBytes();
                password = new String();
            }
            catch (Exception e)
            {
    ...
    public void decryptText()
    {
        ...
        if (password.length() > 0)
        {
            ...
            FileInfo info = new FileInfo();
            byte[] b = new byte[(int)dec_file.length()];
            try
            {
                FileInputStream fin = new FileInputStream(dec_file);
                fin.read(b);
                fin.close();
                String str = info.decryptFirstLayer(new String(b));
                str = info.removeHeaderAndFooter(str);
                str = info.getTextStringEnc(str);
                str = new EncryptionAndDecryption(Integer.parseInt(password)).decryption(str);
                str = new Round2Encryption(password).decryptAES(str);
                str = new PermutationAndRotation(password).afterDecryptionProcess(str, Integer.parseInt(info.num_of_padding_chars));                
                password = new String();
